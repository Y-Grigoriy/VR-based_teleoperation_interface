...
/// <summary>
/// Скрипт для управления дроном с помощью джойстика (inverse kinematic case)
/// Скрипт Inverse_kin_new привязан к объекту DroneArm.Manipulator
/// углы, полученные в юнити, преобразуются в углы для реального манипулятора
/// и собранные в строковое сообщение отправляются на arduino
/// </summary>
...
public class Data_Sending_Vive : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        InvokeRepeating("DataSend", 5f, 0.08f);//sending data to manipulator  было Time.fixedDeltaTime*10
